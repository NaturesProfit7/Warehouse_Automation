...
def get_analytics_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="⚡ Оборачиваемость", callback_data="turnover_analysis")],
        [InlineKeyboardButton(text="🎯 Рекомендации закупок", callback_data="purchase_recommendations")],
        [InlineKeyboardButton(text="🔙 Назад", callback_data="main_menu")]
    ])


def get_analytics_period_keyboard() -> InlineKeyboardMarkup:
    """Клавиатура выбора периода для аналитики."""
    
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="📅 7 дней", callback_data="period_7"),
            InlineKeyboardButton(text="📅 14 дней", callback_data="period_14")
        ],
        [
            InlineKeyboardButton(text="📅 30 дней", callback_data="period_30"),
            InlineKeyboardButton(text="📅 90 дней", callback_data="period_90")
        ],
